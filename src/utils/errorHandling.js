...
const FORM_ERROR_MESSAGES = {
  ...
  glycans: {
    ...
    Duplicate_internalId:
      "Another glycan in your collection has the same Internal ID. Please use another Internal Id",
  ...
  processdata: {
    Internal_Error:
      "Cannot add the intensities to the repository. Please fix the file and reupload.",
  },
  experiments: {
