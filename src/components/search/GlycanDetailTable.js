...
GlycanDetailTable.propTypes = {
  ...
  glycanId: PropTypes.string,
};

GlycanDetailTable.defaultProps = {
  defaultSortColumn: "dateModified",
  defaultSortOrder: 0,
};

export { GlycanDetailTable };
