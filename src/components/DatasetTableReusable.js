...
const DatasetTableReusable = ({ wsName, qsParams }) => {
  ...
  }, [orderBy, publicData.sortBy, wsName, qsParams]);
...
DatasetTableReusable.propTypes = {};

export { DatasetTableReusable };
